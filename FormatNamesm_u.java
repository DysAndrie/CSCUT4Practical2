...
public class FormatNamesm_u {
    ...
    
    {
    	 // Specifiying the inputfile of the textfile. 
    	  ...
    	  File outputFile = new File("C:\\Users\\admin\\Desktop\\Managing Information\\0_MI_TO-DO\\Checkpoint#4\\CSCUT4Practical2-main\\formattedmu.txt"); 
    	   ...
    	   if (i == 0) {
    		...
    		// Gets the index of the last space in the input line,
    	     int dateIndex = line.lastIndexOf(" "); // which separates the name from the date string
    	         ...
    	         //name Format is modified to .toUpperCase to turn all letters ALL CAPS 
    	         out.printf("%-20s%s\n", nameFormat.toString().toUpperCase(), dateFormat);
    	          }
